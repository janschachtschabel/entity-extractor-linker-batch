...
# -*- coding: utf-8 -*-
"""
Minimal example of entity extraction, linking with Wikipedia and results as raw JSON
"""
...
Sie liegt im Wettersteingebirge in den Nördlichen Kalkalpen. 
Die Stadt Garmisch-Partenkirchen liegt in der Nähe.
"""
...
async def main():
    ...
    result = await process_entities(SAMPLE_TEXT, config)
