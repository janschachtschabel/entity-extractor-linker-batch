...
result = create_knowledge_compendium(
    text,
    {
        ...
        "ALLOWED_ENTITY_TYPES": "Person",  # Automatische Filterung erlaubter Entitätstypen
...
# If a compendium was generated, print it
...
logging.info("Gebe Ergebnisse für Personen mit Bild-Url´s aus...")
# Filter entities: only name, Wikipedia URL, and image URL
filtered_entities = []
