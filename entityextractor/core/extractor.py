...
Diese Basismodule enthält die Kernfunktionalität zur Entitätsextraktion ohne Verknüpfung.
Es wird von der API in core/api/extract.py verwendet, die zusätzlich die Verknüpfungsfunktionalität hinzufügt.

BEACHTUNG: Dies ist die Low-Level-Implementierung. Für die vollständige API mit Verknüpfung
verwenden Sie entityextractor.core.api.extract_entities.
"""
